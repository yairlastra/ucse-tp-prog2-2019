...
namespace Logica
{
    internal sealed class Archivos
    {
        ...
        public List<Docente> ObtenerDocentes()
        {
            ...
            {
                ModificarArchivoDocentes(Docentes);
            }
            else
            { 
        ...
        public List<Directora> ObtenerDirectoras()
        {
            ...
            {
                ModificarArchivoDirectoras(Directoras);
            }
            else
            {
        ...
        public List<UsuarioLogin> ObtenerUsuarios()
        {
            ...
            {
                ModificarArchivoUsuarios(Usuarios);
            }
            else
            {
